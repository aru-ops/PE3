...
# Добавлена кнопка выбора цвета машины в настройках
...
while running:
    ...
    if state == "MENU":
        ...
        for coin in coin_hits:
            if settings["sound"] and snd_coin: snd_coin.play()
            coins_collected += 1
